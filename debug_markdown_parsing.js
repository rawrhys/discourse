...
const testContent = `The Formation of the Greek City-States
...
The Polis* emerged alongside three key developments Population Growthg., settlements in southern Italy and Asia Minor) eased pressure on limited land.
...
console.log('\n\n=== PARSED CONTENT ===');
const parsedContent = parseGreekCityStatesContent(testContent);
...
patterns.forEach(pattern => {
  ...
  console.log(`${pattern}: ${matches ? matches.length : 0} occurrences`);
});
