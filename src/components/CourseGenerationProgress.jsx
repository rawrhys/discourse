  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-8 rounded-xl max-w-2xl w-full mx-4 max-h-[85vh] overflow-y-auto shadow-2xl">
        ...
        {/* Rate Limiting Info */}
        {elapsedTime > 60000 && generationProgress.stage === 'generating' && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            <div className="flex items-center space-x-2">
              <div className="text-yellow-600 text-xl">⏳</div>
              <div>
                <p className="text-yellow-800 font-medium">Taking longer than usual?</p>
                <p className="text-yellow-600 text-sm">
                  The AI service may be experiencing high demand. Your course is still being generated - please be patient. 
                  This is normal and your course will be completed successfully.
                </p>
              </div>
            </div>
          </div>
